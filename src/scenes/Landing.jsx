			...
			<div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32">
				{isAboveMediumScreens ? (
					<div className="relative z-0 ml-20 before:absolute before:-top-20 before:-left-20 before:w-full before:max-w-[400px] before:h-full before:border-2 before:border-blue before:z-[-1]">
						<img
							className="hover:filter transition duration-500 z-10 w-500px h-400px max-w-[200px] md:max-w-[400px]"
					...
					<img
						className="hover:filter hover:saturate-200 transition duration-500 z-10 w-500px h-400px max-w-[400px] md:max-w-[600px]"
						src="../assets/profile-image.jpeg"
						alt="profile"
					/>
				)}
			...
			<div className="z-30 basis-2/5 mt-12 md:mt-32">
				...
				>
					...
					<p className="mt-10 mb-7 text-sm text-center md:text-start">
						...
						Esse natus eius tenetur, facere ab necessitatibus
						corrupti nam blanditiis doloremque rerum?
					</p>
				</motion.div>
				{/* CALL TO ACTIONS */}
				<motion.div
